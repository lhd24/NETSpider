...
namespace WinFormLib.Core
{
    ...
    public class TryParse
    {
        ...
        /// <returns></returns>
        public static string DateToStrByChar(object value, string formater)
        {
            if (string.IsNullOrEmpty(TryParse.ToString(value).Trim()))
                return "";
            try
            {
                return DateTime.ParseExact(TryParse.ToString(value), formater, System.Globalization.CultureInfo.CurrentCulture).ToString("yyyy-MM-dd");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        {
            return DateToStrByChar(value, "yyyyMMdd");
        }
        /// <summary>
        ...
        {
            return StrToDate(date).ToString(format);
        }
        /// <summary>
        /// 字符串转成html代码
        /// </summary>
        ...
        public static string ToString(object obj, bool throwException)
        {
            ...
            {
                throw new Exception(obj.GetType().FullName + "值不能为空");
            }
            return str;
        }
        /// <summary>
